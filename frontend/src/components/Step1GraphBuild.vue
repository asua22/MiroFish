    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM analyzes document content and simulation requirement, extracts Reality Seeds, and auto-generates a suitable ontology
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, documents are auto-chunked, then the Zep API builds a knowledge graph, extracts entities and relations, and forms temporal memory and community summaries
          </p>
