...
...
          <p class="description">
            Using context, automatically extract entities and relations from the knowledge graph, initialize simulated agents, and assign them unique behaviors and memories based on Reality Seeds
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          ...
          <div class="step-status">
            ...
            <span v-else-if="phase === 1" class="badge processing">Generating</span>
      ...
      <!-- Step 03: Gen Dual-Platform Config -->
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            <span class="step-num">03</span>
            <span class="step-title">Gen Dual-Platform Config</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM intelligently sets world time flow, recommendation algorithms, individual active time periods, posting frequency, event triggers and other parameters based on Simulation Requirement and Reality Seeds
          </p>
      ...
      <!-- Step 04: Initial Active Orchestration -->
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          <div class="step-info">
            <span class="step-num">04</span>
            <span class="step-title">Initial Active Orchestration</span>
          </div>
          <div class="step-status">
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <!-- Simulation  rounds config - only show after config generation and round calculation -->
          <div v-if="simulationConfig && autoGeneratedRounds" class=" rounds-config-section">
            <div class=" rounds-header">
              <div class="header-left">
                <span class="section-title">Simulation Rounds Setting</span>
                <span class="section-desc">MiroFish auto-plans simulation of <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> hours，each round represents <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes of real-time passing</span>
              </div>
              <label class="switch-control">
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-section" v-if="selectedProfile.interested_topics?.length">
            <span class="section-label">Reality Seeds Related Topics</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              ...
              <div class="dimension-card">
                ...
                <span class="dim-desc">Experience summary & behavioral style</span>
              </div>
              <div class="dimension-card">
              ...
              <div class="dimension-card">
                ...
                <span class="dim-desc">Individual connections & interaction graph</span>
              </div>
            </div>
    ...
    <div class="system-logs">
      ...
      </div> <!-- Close system-logs -->
    </div> <!-- Close scroll-container -->
  </div> <!-- Close env-setup-panel -->
</template>
...
watch(currentStage, (newStage) => {
  if (newStage === 'Generate Agent Personas' || newStage === 'generating_profiles') {
    ...
    if (!configTimer) {
      addLog('Start Generating Dual-Platform Config...')
      startConfigPolling()
    }
...
// Count total related topics across all personas
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog('Detected existing prepared data, using it directly')
      ...
      // Set Expected Total Agents immediately (from prepare API)
...
const fetchProfilesRealtime = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Output Profile Gen Progress logs (only on count change)
    ...
    if (res.success && res.data) {
      ...
      if (data.config_generated && data.config) {
        ...
        if (data.config.time_config) {
          ...
          addLog(`Time config: Every round ${tc.minutes_per_round} minutes, total ${Math.floor((tc.total_simulation_hours * 60) / tc.minutes_per_round)} rounds`)
        }
