        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-tabs">
            ...
            >
              ...
              <span>Send survey to agents in the world</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Quick chat version of the Report Generation agent. Can invoke 4 professional tools with MiroFish's full memory.</div>
              </div>
              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-based instant query interface, optimized index efficiency for quickly extracting node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviews conducting parallel multi-round dialogues with simulated individuals, collecting unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent for deeper report insights' : 'Chat with simulated agents to learn their perspectives' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="Enter the question for all selected subjects..."
                rows="3"
              ></textarea>
            </div>
            ...
            <div class="results-list">
              ...
              >
                <div class="result-header">
                  ...
                  <span v-if="result.simulated" class="simulated-badge" title="Environment offline — response generated by LLM from agent profile">LLM Simulated</span>
                </div>
...
const renderMarkdown = (content) => {
  ...
  // Clean <p><br> followed by block elements (from extra blank lines)
  html = html.replace(/<p class="md-p">(<br>\s*)+(<ul|<ol|<blockquote|<pre|<hr)/g, '$2')
  // Clean consecutive <br> tags
  html = html.replace(/(<br>\s*){2,}/g, '<br>')
  // Clean <br> before paragraph opening tag after block elements
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Fix non-contiguous ordered list numbering: keep incrementing when single <ol> items are separated by paragraph content
...
const submitSurvey = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      const isSimulated = res.data.simulated === true
      const resultData = res.data.result || res.data
      const resultsDict = resultData.results || resultData
      ...
      for (const interview of interviews) {
        ...
        let responseSimulated = isSimulated
        ...
        if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
          ...
          if (agentResult) {
            ...
            responseSimulated = agentResult.simulated === true || isSimulated
          }
        ...
        surveyResultsList.push({
          ...
          simulated: responseSimulated
        })
      }

      surveyResults.value = surveyResultsList
      const simLabel = isSimulated ? ' (LLM simulated — environment offline)' : ''
      addLog(`Received ${surveyResults.value.length} replies${simLabel}`)
    } else {
      throw new Error(res.error || 'Request failed')
    }
  } catch (err) {
...
/* Fix ordered list numbering - use CSS counters for consecutive numbering */
.message-text {
