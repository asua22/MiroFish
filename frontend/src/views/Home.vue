    ...
    <!-- Top navbar -->
      ...
      <div class="main-content">
        ...
        <section class="hero-section">
          <div class="hero-left">
             <div class="tag-row">
             <span class="orange-tag">Social Media Simulation Engine</span>
             <span class="version-text">/ v0.1-Preview</span>
           </div>
           
           <h1 class="main-title">
             <br>
             <span class="gradient-text">Upload any report / Simulate the future instantly</span>
           </h1>
           
            <div class="hero-desc">
              <p>
                Even if there is only one paragraph, <span class="highlight-bold">MiroFish</span> it can also automatically generate a corresponding parallel world composed of up to <span class="highlight-orange">millions of Agents</span> constituted parallel world. Inject variables from a god's-eye view, find in complex group interactions under dynamic environments the <span class="highlight-code">"local optimum"</span>
              </p>
              <p class="slogan-text">
                Let the future be rehearsed in the agent swarm, and let decisions prevail after countless battles.<span class="blinking-cursor">_</span>
              </p>
            </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine is ready, you can upload multiple unstructured data to initialize the simulation sequence
          </p>
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Reality Seeds extraction & individual & group memory injection & GraphRAG Build</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity-relationship extraction & persona generation & env config agent parameter injection</div>
                </div>
              </div>
              <div class="workflow-item">
...
// Start Simulation - redirect immediately, API calls in Process page
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Redirect to Process page (special 'new' identifier for new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /* 
    Use Space Grotesk as main headline font, JetBrains Mono for code/labels
