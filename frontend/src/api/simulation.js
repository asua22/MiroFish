...
/**
 * Get real-time generating agent profiles
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
 */
...
/**
 * Get real-time generating simulation config
 * @param {string} simulationId
...
/**
 * Get simulation real-time status
 * @param {string} simulationId
 */
...
/**
 * Get simulation detailed status (with recent actions)
 * @param {string} simulationId
 */
